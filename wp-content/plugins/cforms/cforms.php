	...
	for($i = 1; $i <= $field_count; $i++) {
		...
		switch($field_type) {
			...
			case "upload":
				...
				$field = '<div id="file_browse_wrapper"><input' . $readonly.$disabled . ' type="file" name="cf_uploadfile'.$no.'[]" id="cf_uploadfile'.$no.'-'.$i.'" class="cf_upload ' . $field_class . '"'.$fieldTitle.'/></div>';
				break;
